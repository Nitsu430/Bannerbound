...
public class bellowsAnimation {
	public static final AnimationDefinition Push = AnimationDefinition.Builder.withLength(1.0F)
		...
		.addAnimation("Bellows_Top", new AnimationChannel(AnimationChannel.Targets.SCALE, 
		...
		.addAnimation("Spine", new AnimationChannel(AnimationChannel.Targets.SCALE, 
			new Keyframe(0.0F, KeyframeAnimations.scaleVec(1.0F, 1.0F, 1.0F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(0.125F, KeyframeAnimations.scaleVec(1.0F, 0.3F, 1.0F), AnimationChannel.Interpolations.CATMULLROM),
